...
export const th = {
    ...
    translation: {
        ...
        profileเหรียญs: {
            ...
            labelYourเหรียญ: `${getAppName()} เหรียญ ของคุณ`,
            noteBalanceUpdate:
                "ในบางกรณี อาจใช้เวลาสูงสุด 5 นาทีในการอัปเดตยอดเงิน กรุณารอสักครู่",
            noteเหรียญTerms: `• ${getAppName()} เหรียญ สามารถใช้ได้โดยไม่มีวันหมดอายุ และสามารถใช้ร่วมกับคูปองบัญชีอื่นได้• ${getAppName()} เหรียญ ไม่สามารถแลกเป็นเงินสดหรือโอนไปยังบัญชี ${getAppName()} อื่นได้• เมื่อคุณเติม ${getAppName()} เหรียญ เข้าระบบ จะถือว่าคุณยอมรับข้อกำหนดและเงื่อนไข• หากคุณพบปัญหาในการเติมเงิน ${getAppName()} เหรียญ หรือชำระเงิน กรุณาติดต่อศูนย์ช่วยเหลือ`,
            ...
            subtitleFastworkเหรียญ: "เติมเงินออนไลน์เพื่อความสะดวกในการจ้างฟรีแลนซ์",
            ...
            tableTotalเหรียญs: "เหรียญทั้งหมดที่ได้รับ",
            titleFastworkเหรียญ: `${getAppName()} เหรียญ`,
        ...
        terms: {
            ...
            เหรียญs1: `ลูกค้าเติม ${getAppName()} เหรียญs เพื่อชำระค่าธรรมเนียม`,
            เหรียญs2: "เหรียญs ต้องใช้ภายใน 2 ปี",
            เหรียญs3: "เหรียญs ที่ไม่ใช้เสียค่าธรรมเนียม 1 USD/เดือน",
            เหรียญs4: "การคืนเงิน เหรียญs เสียค่าธรรมเนียมการทำธุรกรรม 1 USD",
            เหรียญs5: "เหรียญโบนัสs มอบให้เมื่อใช้งานตามเงื่อนไข",
            เหรียญs6: "เหรียญโบนัสs ต้องใช้ภายใน 1 ปี",
        ...
        termsEmployer: {
            ...
            definitionFastworkเหรียญ: `“เงินในระบบ (${getAppName()} เหรียญ)” หมายถึง คะแนนที่ผู้ว่าจ้างเติมเข้าไปในบัญชีผู้ใช้งานเพื่อใช้ชำระค่าบริการ หรือค่าธรรมเนียมการชำระเงิน`,
            definitionBonusเหรียญ:

...
import Post from "@/components/Header/components/UserMegaMenu/Post";
    ...
    const megaFreelancer: FreelanceMegaMenuItem[] = [
        {
            ...
            title: t("global.labelMenuOption12"),
            description: t("global.hintLabelMenuOptionSearchJobBoard"),
        },
    ];
    ...
    return (
        <div className="grid-container-desktop w-full">
            <div className="col-start-2 col-end-3 flex">
                ...
                {t("global.tittleHeaderMenuSection1")}
              </span>
                        </div>

...
[CustomHttp docs](https://join-lemmy.org/docs/contributors/04-api.html)

```ts
import { CustomHttp, Login } from "lemmy-js-client";

// Build the client
const baseUrl = "https://lemmy.ml";
const client: CustomHttp = new CustomHttp(baseUrl);
